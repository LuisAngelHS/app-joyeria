...
const products = [
  {
    ...
    description: 'Símbolo de eternidad'
  },
  {
    id: 2,
    name: 'Pulsera Cadena Clásica',
    price: '$750',
  ...
  },
  {
    ...
    description: 'Con dijes personalizables'
  },
  {
    id: 4,
    name: 'Pulsera Rígida',
    ...
    description: 'Diseño bold y moderno'
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description: 'Con circonias brillantes'
  }
]
  ...
  <div>
    ...
    <section class="relative h-[50vh] flex items-center">
      <div class="absolute inset-0 z-0">
        <img 
          src="https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=1920&h=800&fit=crop" 
          alt="Pulseras de plata"
      ...
      <UContainer class="relative z-10">
        <div class="text-center">
          ...
          />
          <h1 class="font-serif text-5xl md:text-6xl text-white mb-4">Pulseras</h1>
          <p class="text-white/80 text-lg max-w-2xl mx-auto">
            Pulseras que complementan tu estilo. Desde delicadas cadenas hasta 
            diseños audaces que hacen una declaración.
          </p>
        </div>
      </UContainer>
    </section>
